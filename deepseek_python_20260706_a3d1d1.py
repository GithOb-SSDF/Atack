...
{Fore.RED}║  {Fore.GREEN}║  🤖 MCBOT v1.0 - CHAT EN VIVO                                   ║ {Fore.RED}║
{Fore.RED}║  {Fore.GREEN}║  📡 SE CONECTA, SE REGISTRA Y MUESTRA EL CHAT                  ║ {Fore.RED}║
...
def main():
    ...
    bot = MCBot(ip, puerto, nombre, password)
